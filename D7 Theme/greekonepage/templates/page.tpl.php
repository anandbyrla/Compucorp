        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php if (!empty($site_slogan)): ?>
                  <div class="description"><p class="lead"><?php print $site_slogan; ?></p></div>
                <?php endif; ?>
                    
                <div class="col-md-12 col-sm-12 col-xs-12 arrow-down"><a class="page-scroll" href="#design"><img src="<?php global $base_url; print $base_url;?>/sites/all/themes/greekonepage/img/white-down-arrow.png" alt="down-arrow"></a></div>
            </div>
        </div>
    </div>
</header>
...
<section id="map-section" class="map-section">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12 arrow-down">
              <a class="page-scroll" href="#contact">
                <img src="sites/all/themes/greekonepage/img/pink-down-arrow.png" alt="down-arrow">
              </a>
          </div>
</section>
<?php endif; ?>
